...
[![Skills](https://img.shields.io/badge/skills-19-brightgreen.svg)](#skills-catalog)
...
| Skill | Description | Difficulty |
|-------|-------------|------------|
| [ue5-blueprint](skills/ue5-blueprint/) | Blueprint visual scripting patterns and best practices | ★★☆ |
| [ue5-materials](skills/ue5-materials/) | Material Editor node graphs and shader development | ★★★ |
| [ue5-multiplayer](skills/ue5-multiplayer/) | Replication, RPCs, and multiplayer architecture | ★★★ |
...
**Built with 🎮 by [tinyfish](https://github.com/Y1-q-1Q) & IceBaby 🧊**
...
- Workspace 真相层：`C:\Users\tinyfish\.openclaw\workspace\docs\10-docs-governance\WORKSPACE-DOC-INDEX.md`
- 本仓库 docs：`./docs/`（如存在）
